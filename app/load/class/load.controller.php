...
if(defined('LOAD_CONTROLLER_PHP'))
{
    return;
}
else
{
    define('LOAD_CONTROLLER_PHP', 1);
}
...
class LoadController extends AppController
{
    ...
    public function index()
    {
        ...
        $this->view->display('LoadPage');
    }

    public function cached()
    {
        $this->view->assign('controller', $this);
        $this->view->display('CachedPage');
    }

    public function dramatic()
    {
        $this->view->assign('controller', $this);
        $this->view->display('DramaticPage');
    }
