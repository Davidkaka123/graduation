require([
    ...
    var agoLayer = new ArcGISTiledMapServiceLayer("http://localhost:6080/arcgis/rest/services/radiowatch/radiowatchBaseMap/MapServer");

    map.addLayer(agoLayer);

    var dynamicMapServiceLayer = new ArcGISDynamicMapServiceLayer("http://localhost:6080/arcgis/rest/services/radiowatch/surfaceoildata/MapServer");
